...
# This file initiates and runs the trajectory-based simulation for Single-Sided 0-degree Configuration with long spots 
...
def eval_Ns(N, N_s):
	...
	for k in range(0, 1 + N_s):	
		...
		test = system(N, N_s, k, SEED_SERV[N-1], SEED_POUT[N-1], SEED_PLIN[N-1], SEED_DRIV[N-1])
