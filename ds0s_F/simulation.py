...
# This file initiates and runs the trajectory-based simulation for Double-Sided 0-degree Configuration with short spots 
...
A_s = LOT_LENGTH * (2 * (LOT_WIDTH + 8) + LANE_WIDTH) 
